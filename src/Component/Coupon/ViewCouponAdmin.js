...
export default function ViewCouponAdmin(){
                            ...
                            <MDBCard className="mb-4">
                                <MDBCardHeader className="py-3">
                                    <MDBTypography tag="h5" className="mb-0 d-flex">
                                        <FaArrowLeft className="mt-1 me-2" onClick={()=>(navigate(`/adminDetails/${adminId}`))} style={{cursor:"pointer"}}/> Back to Page
                                        <button className="btn btn-dark justify-content-end"
                                           style={{position:"absolute",right:15}} onClick={()=>(navigate(`/addCoupon`))}>Add Coupon</button>
                                    </MDBTypography>
                                    <hr/>
